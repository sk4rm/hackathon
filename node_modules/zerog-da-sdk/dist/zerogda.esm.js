...
function makeError(message, code, info) {
    {
        ...
        details.push(`version=${version$2}`);
        if (details.length) {
...
function dataSlice(data, start, end) {
    ...
    return hexlify$1(bytes.slice((start == null) ? 0 : start, (end == null) ? bytes.length : end));
}
...
keccak256$1.lock = function () { locked = true; };
...
function getBuiltinCallException(action, tx, data, abiCoder) {
    ...
    if (data) {
        ...
        else if (hexlify$1(bytes.slice(0, 4)) === "0x08c379a0") {
            // Error(string)
            try {
        ...
        else if (hexlify$1(bytes.slice(0, 4)) === "0x4e487b71") {
            // Panic(uint256)
            try {
...
getSelector(fragment: ErrorFragment | FunctionFragment): string {
    ...
    */
    ...
    encodeFunctionResult(fragment, values) {
        ...
        return hexlify$1(this.#abiCoder.encode(fragment.outputs, values || []));
    }
    /*
...
class ContractFactory {
    ...
    constructor(abi, bytecode, runner) {
        ...
        if (bytecode instanceof Uint8Array) {
            bytecode = hexlify$1(getBytes(bytecode));
        }
        else {
...
function calculateSubmissionFee(submission) {
